...
export const Home: React.FunctionComponent = () => {
    return (
        <>
            <Typography variant="h3" sx={{ textAlign: 'center', fontWeight: 600, textTransform: 'uppercase', padding: 5 }}>Choosing the right database for your serverless stack is just a few clicks away!</Typography>
